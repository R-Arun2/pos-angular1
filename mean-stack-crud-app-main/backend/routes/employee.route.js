...
employeeRoute
  ...
  .get(async (req, res, next) => {
    console.log("kumnnnnnnnnnnnnnnnnnnnnnnnn")
...
employeeRoute.route("/read/:id").get(async (req, res, next) => {
  console.log("singnnnnnnnnnnnnnnnnnnnnnnn")
...
employeeRoute.route("/update/:id").put(async (req, res, next) => {
  ...
  console.log("updatennnnnnnnnnnnnnnnnnnnnnnn")
...
employeeRoute.route("/delete/:id").delete(async (req, res) => {
  ...
  console.log("deletennnnnnnnnnnnnnnnnnnnnnn")
